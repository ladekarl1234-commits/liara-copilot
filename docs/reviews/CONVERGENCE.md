...
| 003-fixed | `b1d8604` | ~93/100 | 0 | 1 | 1 | ~9 | verification caught a NEW P1: fabricated absent-feature list false-refused documented k8s/GPU/refund | remediated in c224ce5 |
| 004 (verify) | `b1d8604` | ~93/100 | 0 | 1 | 2 | — | detectAbsentFeature P1 (false-refuses documented features), exfil over-narrow P2, negation abandon P2 | remediated |
| 004-fixed | `c224ce5` | ~93/100 | 0 | 1 | 1 | ~9 | reverify: P1 gone (k8s/GPU/refund answer); BUT fix introduced exfil over-broaden (P1) + negation dropped (P2) | remediated |
| 005 (reverify) | `c224ce5` | ~93/100 | 0 | 1 | 1 | — | exfil over-broadening false-blocks token questions; negation "dropped"; absent-feature disagreement | exfil precise (verb+your+noun), dropped bare cues; disagreement RESOLVED (removal correct, managed-cluster gates low) |
| 005-fixed | `<final>` | ~93/100 CONVERGED | 0 | 0 | 0 | ~8 P3/accepted | no open actionable P0/P1/P2; residuals documented | Phase-II converged |
